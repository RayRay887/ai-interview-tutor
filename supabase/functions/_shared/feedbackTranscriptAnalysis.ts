/** Heuristic transcript analysis for interview-feedback edge function. */
...
export function formatTranscriptSignalsForPrompt(signals: TranscriptSignals): string {
  ...
  lines.push(
    '- complexityQuestionAsked=true AND complexityAnsweredInSpeech=false → time_complexity=1, space_complexity=1, optimization_tradeoffs≤2, answer_relevance≤2',
  )
